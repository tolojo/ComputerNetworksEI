...
10. Caso haja algum problema de incompatibilidade no arranque da máquina, por favor verifique que em a *VT Technology* (VT-x) ativa na bios do seu computador. Normalmente essa opção encontra-se facilmente mas, por favor, consulte a documentação do fabrincante caso seja necessário.
